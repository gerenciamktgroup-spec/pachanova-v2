// AUTO-GENERATED — pachanova-production (wdrhurnbxkhwmqrcbgpu)
  ...
  public: {
    Tables: {
      ...
      user_onboarding_steps: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_onboarding_steps_investor_id_fkey"
            columns: ["investor_id"]
            isOneToOne: false
            referencedRelation: "investors"
            referencedColumns: ["id"]
      ...
      yield_projections: {
        Row: {
          ...
          period_year: number
          projected_token_value_usd: number | null
          projected_total_return_usd: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "yield_projections_property_id_fkey"
            columns: ["property_id"]
            isOneToOne: false
            referencedRelation: "properties"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      deposit_funds: {
        Args: { p_amount: number; p_investor_id: string; p_payment_reference?: string }
        Returns: Json
      }
