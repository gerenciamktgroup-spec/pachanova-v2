...
export default function PrecisionSpatialLanding() {
  const jsonLd = {
    ...
    "name": "PachaNova",
    "image": "https://pachanova.com/og-image.jpg",
    "description": "El primer fideicomiso inmobiliario tokenizado de Perú. Tierra real. Valor real. Acceso real.",
    ...
    "makesOffer": {
      "@type": "Offer",
      "name": "Tokens Inmobiliarios - San Bartolo",
      "description": "Participación fraccional de terreno en San Bartolo respaldada por fideicomiso.",
      "price": "10.00",
      "priceCurrency": "USD"
    }
  };
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-7xl md:text-[92px] leading-[0.90] font-semibold tracking-[-4.6px] mb-7">
              ...
              Construye legado.<br />
              <span className="text-[#c5a46d]">Protege tu capital.</span>
            </h1>

            <p className="text-[21px] text-white/70 max-w-md tracking-[-0.2px] mb-12">
              El primer fideicomiso inmobiliario tokenizado de Perú. Adquiere fracciones de suelo físico desde $10, con respaldo legal y liquidez digital.
            </p>
